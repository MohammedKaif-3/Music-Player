...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> implements MusicPlayerService.OnSongChangeListener{
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            musicPlayerService.addOnSongChangeListener(RecyclerViewAdapter.this);
    ...
    public void onDetachedFromRecyclerView(@NonNull RecyclerView recyclerView) {
        if (isBound) {
            musicPlayerService.removeOnSongChangeListener(RecyclerViewAdapter.this);
    ...
    public RecyclerViewAdapter(Context context, ArrayList<Song> songsList) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if(song.getPath().equals(currentSongPath)){
                ...
                Executors.newSingleThreadExecutor().execute(() -> {
                    ...
                    MusicPlayerInstance.setPlayingQueue(1);
    ...
    private void updateViewHolder(MyViewHolder holder, MediaMetaDataHelper.MediaMetadata metadata) {
    ...
    private void updateCurrentSongUI(MyViewHolder holder, String songPath) {
